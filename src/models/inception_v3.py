...
def Inceptionv3(include_top=True,
    ...
    # Create model.
    model = keras.applications.InceptionResNetV2(include_top=False, input_shape=(331, 331, 3), weights=None,input_tensor=input_layer)
    weights_path = keras.utils.get_file(
        'inception_res_v2_weights_tf_dim_ordering_tf_kernels_notop.h5',
        'https://lajibulaji.obs.cn-north-1.myhuaweicloud.com:443/inception_resnet_v2_weights_tf_dim_ordering_tf_kernels_notop.h5?AccessKeyId=PG8ZG7CXDO0QSWGWZPNW&Expires=1567957452&Signature=4Xa2mlw3tzA5y%2FGSIuaGdW02pU8%3D',
        cache_subdir='models',
